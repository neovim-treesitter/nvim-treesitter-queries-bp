# nvim-treesitter-queries-bp

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-bp/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-bp/actions/workflows/validate.yml)

Neovim tree-sitter queries for **bp**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-bp",
...
- [ ] Changes are scoped to `bp` — do not include files for other languages
